...
class MainItemDetailsController extends BaseController {
	...
	public function showRecords()
	{
		$itemDetails = DB::table('tblitemdetails')
			...
			->select('tblitemdetails.ItemID', 'tblitemtype.ItemType', 'tblitemtype.ItemCode', 'tblitemdetails.status', 'tblitemdetails.DateTime', 'tblitemdetails.ItemTypeID')
		...
		if(Request::ajax()){
			...
			if($result == 0)
			{
				...
				$iDetails = DB::table('tblitemdetails')
					->join('tblitemtype', 'tblitemdetails.ItemTypeID', '=', 'tblitemtype.ItemTypeID')
					->select('tblitemdetails.ItemID', 'tblitemtype.ItemType', 'tblitemtype.ItemCode', 'tblitemdetails.status', 'tblitemdetails.DateTime')
					//->orderBy('tblitemdetails.DateTime', 'asc')
					->orderBy('tblitemdetails.itemTypeID', 'asc')
					->orderBy('tblitemdetails.ItemID', 'asc')
					->get();
	...
	public function getInfo()
	{
		if(Request::ajax())
		{
			$itemInfo = DB::table('tblitemdetails')
				->join('tblitemtype', 'tblitemdetails.ItemTypeID', '=', 'tblitemtype.ItemTypeID')
				->select('tblitemdetails.ItemID', 'tblitemtype.ItemType', 'tblitemtype.ItemCode', 'tblitemdetails.status', 'tblitemdetails.DateTime', 'tblitemtype.ItemTypeID')
